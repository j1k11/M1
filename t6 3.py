...
# Збережіть цей код у файлі, наприклад, main_program.py

from olympic import run
from rectangle_module import perimeter

s = int(input("Введіть відстань дистанції: "))
t = int(input("Введіть витрачений час на дистанцію: "))

# Використання функції run() з модулю olympic
result = run(s, t)

# Виведення результату на екран
print(f"Швидкість спортсмена: {result}")
